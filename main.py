...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='TransE', choices=['TransE', 'RotatE', 'DistMult', 'ComplEx','TransD'])
    ...
    parser.add_argument("--mu", type=float, default=0.005, help="mu, type float, default 0.0")
    parser.add_argument("--mu_contrastive", type=float, default=0.005)
