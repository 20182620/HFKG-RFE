...
class KGEModel(nn.Module):
    def __init__(self, args, model_name):
        ...
        #这一行计算并设置了模型中的 embedding_range 属性。
        # embedding_range 是一个大小为 1 的张量，其值为 (args.gamma + args.epsilon) / args.hidden_dim，
        # 它用于限制实体嵌入和关系嵌入的初始化范围。
    ...
    def TransD(self, head, relation, tail):
